...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "Crear Usuario externo - Model", description = "Entidad para crear los usuarios externosadministrar transacciones con Usuarios Externos")
public class CrearUserExtDTO {
